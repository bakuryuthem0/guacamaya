...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-03-2015 a las 12:19:39
...
--
CREATE DATABASE IF NOT EXISTS `guacamaya` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `guacamaya`;
...
INSERT INTO `colores` (`id`, `color_nomb`, `color_desc`, `created_at`, `updated_at`) VALUES
(1, 'amarillo', 'Amarillo', '2015-03-08', '2015-03-08'),
(2, 'azul', 'Azul', '2015-03-08', '2015-03-08'),
(3, 'rojo', 'Rojo', '2015-03-08', '2015-03-08');
...
INSERT INTO `item` (`id`, `item_cod`, `item_nomb`, `item_desc`, `item_stock`, `item_prov`, `created_at`, `updated_at`) VALUES
(7, '0001', 'Articulo primero', '<p>dfafefewfwfwefwefewfwefefewfefewf</p>\r\n', 50, 0, '2015-03-11', '2015-03-11'),
(8, '0002', 'Articulo segundo', '<p>dkafkafksfkaskfk</p>\r\n\r\n<p>afksfksafk&nbsp;</p>\r\n', 100, 0, '2015-03-11', '2015-03-11');
...
INSERT INTO `miscelanias` (`id`, `item_id`, `item_talla`, `item_color`, `img_1`, `img_2`, `img_3`, `img_4`, `img_5`, `img_6`, `img_7`, `img_8`, `updated_at`, `created_at`) VALUES
(4, 7, '2', '2', '7/maxresdefault.jpg', '7/portada.png', NULL, NULL, NULL, NULL, NULL, NULL, '2015-03-11', '2015-03-11'),
(5, 7, '2', '3', '7/logo-01.png', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2015-03-11', '2015-03-11'),
(6, 7, '3', '2', '7/pronto.png', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2015-03-11', '2015-03-11'),
(7, 8, '1', '3', '8/portada.png', '8/casual-01.png', NULL, NULL, NULL, NULL, NULL, NULL, '2015-03-11', '2015-03-11'),
(8, 8, '3', '2', '8/logo2.png', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2015-03-11', '2015-03-11');
...
INSERT INTO `tallas` (`id`, `talla_nomb`, `talla_desc`, `created_at`, `updated_at`) VALUES
(1, 's', 'tamaño pequeño', '2015-03-08', '2015-03-08'),
(2, 'm', 'tamaño mediano', '2015-03-08', '2015-03-08'),
(3, 'g', 'tamaño grande', '2015-03-08', '2015-03-08');
...
INSERT INTO `usuario` (`id`, `username`, `password`, `dir`, `email`, `telefono`, `cedula`, `created_at`, `updated_at`, `nombre`, `apellido`, `ciudad`, `estado`, `role`, `user_deleted`) VALUES
(1, 'admin', '$2y$08$EiGNW.dQp1X2X0/4GvWgGuGXLPUwWdsqe3zhZarOV8e1tkKcnV96m', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0);
