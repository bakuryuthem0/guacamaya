  ...
  background-color: #286090;
   ...
   <body style="font-family:'Roboto','san serif';padding:2em 4em;">
      ...
      <div>
         ...
         <ul>
            <li>Este mensaje le fue enviado debido a la creacion de un nuevo en <strong>guacamayastores.com.ve</strong>. .</li>
         </ul>
	     
        <p class="bg-primary" style="padding:1em;">Creado por: {{ $createBy }}</p>
        <p class="bg-primary" style="padding:1em;">Monto: {{ $monto.' Bs.F' }}</p>
        <p class="bg-primary" style="padding:1em;">Numero de transacción: {{ $num_trans }}</p>
         <ul>
	      ...
	      <p  style="text-align:center;">Atentamente <span class="bg-primary" style="color:white;">guacamayastores.com.ve</span></p>
	  </div>
   </body>
</html>