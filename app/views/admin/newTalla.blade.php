			...
			<div class="col-xs-8 contForm contdeColor contCentrado" style="margin-top:2em;">
				...
				<div class="col-xs-12">
					<div class="col-xs-12">
						...
						<p class="textoPromedio">Llene el siguiente formulario para registrar una nuevo talla.</p>
						<hr>
					</div>						
				</div>
				<form action="{{ URL::to('talla/nuevo/enviar') }}" id="formRegister" method="POST">
					
					<div class="col-xs-12 formulario">
						<div class="col-xs-12 inputRegister">
							<p class="textoPromedio">Nombre de la talla:</p>
							<p class="bg-info textoPromedio" style="padding:0.5em;text-align:center;">* Nombre para las busquedas(sin acento)</p>
						</div>
						<div class="col-xs-12 inputRegister">
							{{ Form::text('name_color', Input::old('name_color'),array('data-trigger' => "blur",'class' => 'form-control cat_nomb inputForm inputFondoNegro','placeholder' => 'Nombre de la talla',)) }}
					...
					<div class="col-xs-12 formulario">
						<div class="col-xs-12 inputRegister">
							<p class="textoPromedio">Título de la talla:</p>
							<p class="bg-info textoPromedio" style="padding:0.5em;text-align:center;">* Título para mostrar el talla (puede tener acento)</p>
						</div>
						<div class="col-xs-12 inputRegister">
